...
async function PaymentRequest(userId, planId, price, userName, emailAddress, mobileNo, languageid, req, res ) 
{
  ...
  var ReqUrl = appsetting.Payment_KNET.PaymentReqUrl + "?product=Internet Card&price="+price+"&qty=1&total="+price+"&name="+userName+"&address=&postal=&languageCode="+languageCode +"&userId="+userId+"&planId="+planId;
...
router.get("/PurchasePlan", (req, res) => {
  ...
  function StorePaymentDetails(PD, req, res) {
    var paymentDetails = new PaymentDetails({
      ...
      paymentGetwayType: constant.PaymentType.KNET,
      isActive: true,
      isDeleted: false,
  ...
  router.get("/Response", (req, res) => {
    ...
    if(req != null && req.query != null && req.query.result == "CAPTURED")
    {
        ...
        paymentDetails.statusMessage = "Transaction " + (req.query.result == undefined) ? "" : req.query.result,  
